...
import kotlinx.android.synthetic.main.dialog_quick_view.view.*
...
class QuickViewController (val characterScreen: CharacterScreen){
    ...
    init{
        ...
        quickViewDialog.setCanceledOnTouchOutside(!characterScreen.isTablet)
        quickViewDialog.window!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))

        if(characterScreen.isTablet){
            val quickViewView = quickViewDialog.layoutInflater.inflate(com.glasswellapps.iact.R
                .layout
                .dialog_quick_view, characterScreen.quickview_container)

            weapon = quickViewView.quick_view_weapon
            weapon1 = quickViewView.quick_view_weapon1
            armor = quickViewView.quick_view_armor
            acc = quickViewView.quick_view_acc
            acc1 = quickViewView.quick_view_acc1
            acc2 = quickViewView.quick_view_acc2
            weaponType = quickViewView.weapon_type
            weapon1Type = quickViewView.weapon1_type
            armorType = quickViewView.armor_type
            accType = quickViewView.acc_type
            acc1Type = quickViewView.acc1_type
            acc2Type = quickViewView.acc2_type
            mods = quickViewView.quickview_mods
            mods1 = quickViewView.quickview_mods1
            showModsButton = quickViewView.show_mods
            modsGrid = quickViewView.mods_grid_view
        }
        else {
