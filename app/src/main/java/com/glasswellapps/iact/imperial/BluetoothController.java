...
public class BluetoothController implements Observer {
    ...
    public void sendCharacter(boolean updateImages){
        if(bluetoothManager!=null) {
            bluetoothManager.writeToStream(NetworkProtocol.sendCharacter(bluetoothManager.id, character, updateImages));
        }
    }
    ...
    public void update(Observable observable, Object o) {
        ...
        //Toast.makeText(characterScreen,status,Toast.LENGTH_SHORT).show();
    }
}
