...
import com.glasswellapps.sfs.database.AppDatabase
import com.glasswellapps.sfs.database.CharacterData
import com.glasswellapps.sfs.effects.Sounds
import com.glasswellapps.sfs.characters.*
...
class LoadScreen : AppCompatActivity() {
    ...
    var loadedCharacters = ArrayList<com.glasswellapps.sfs.characters.Character>()
...
*/
    ...
    fun selectCharacter(characterName: String?): com.glasswellapps.sfs.characters.Character {
...
class LoadFileAdapter(
    ...
    : ArrayList<com.glasswellapps.sfs.characters.Character>, val data: List<CharacterData>?
)
